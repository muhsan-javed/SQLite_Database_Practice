...
import com.muhsanjaved.sqlite_database_practice.data.PetContract;
...
//        long newRoID = db.insert(PetContract.PetEntry.TABLE_NAME, null, values);
//        Log.v("EditorActivity", "new Ro Id   " + newRoID);

//        Uri newUri = getContentResolver().insert(PetEntry.CONTENT_URI, values);
//        // Show a toast message depending on whether or not the insertion was successful
//        if (newUri == null) {
//            // If the new content Uri is null the there was an error with insertion.
//            Toast.makeText(this, getString(R.string.editor_inser_pet_failed), Toast.LENGTH_SHORT).show();
//        } else {
//            // Other wise the insertion was successful and we can display a toast.
//            Toast.makeText(this, getString(R.string.editor_inserting_pet_successful) + newUri, Toast.LENGTH_SHORT).show();
//        }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // If this is a new pet, hide the delete
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                // Do nothing for now
//                insertPet();
                //going back mainActivity
                savePet();
                finish();
                return  true;
            // Respond to a click on the "Delete" menu option
            case R.id.action_delete:
                // Pop up conframtion dialog for deletion
    ...
    public void onBackPressed() {
        ...
        // Create a click listener to handle the user confirming that changed should be discarded.
        DialogInterface.OnClickListener discardButtonClickListener = new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                // User Click "Discard button" close the current activity
                finish();
                Toast.makeText(EditorActivity.this, "discardButtonClickListener", Toast.LENGTH_SHORT).show();
            }
        };
    ...
    //Show a dialog that warns the user there are unsaved changed that will be lost
    // if they continue leaving the editor.
    //discardButtonClickListener is the click listener for what to do when the user confirms they want to discard their changes
    ...
    private void deletePet(){
        ...
        if (mCurrentPetUri != null){
            ...
            if (rowsDeleted ==0){
                ...
                Toast.makeText(this, getString(R.string.editor_delete_pet_successfull), Toast.LENGTH_SHORT).show();
            }
